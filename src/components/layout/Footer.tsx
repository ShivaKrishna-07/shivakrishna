...
function Footer() {
  return (
    <footer className="flex flex-col max-w-screen px-5 py-10 border-t border-fun-pink-darker z-5 bg-bg">
                        ...
                        >
                          {item.icon && (
                            <span className="pr-2 -mb-1">
                              <item.icon className="text-white transition-colors duration-150 hover:text-accent-foreground" />
                            </span>
                          )}
                          {item.name}
                        </a>
